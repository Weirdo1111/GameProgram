...
`craftpix_reaper_man_1/`, `craftpix_reaper_man_2/`, and `craftpix_reaper_man_3/` supply three full Reaper Man animation sets reserved for Level 2 enemy design. Each set imports 17 PNG sequences: air slash, air throw, death, fall, hurt, idle, idle blink, jump loop, jump start, kick, run, run slash, run throw, slash, slide, throw, and walk.
